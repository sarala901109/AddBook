...
void QtAddressBookGUI::createWidgets()
{
    ...
    searchContactField = new QLineEdit("Enter firstname to search") ;
...
void QtAddressBookGUI::searchContact()
{
    ...
    Contact::ContactId idOfSearchItem = list->searchList(nameTosearch);
    detailView->clear();
    detailView->displayContact(idOfSearchItem);
}
